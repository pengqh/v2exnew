...
- (void)configureContainerView {
    ...
    self.usernameField.text = @"pengquanhua";
...
- (void)login {
    ...
    if (!self.isLogining) {
        ...
        if (self.usernameField.text.length && self.passwordField.text.length) {
            ...
            [[QHDataManager manager] UserLoginWithUsername:self.usernameField.text password:self.passwordField.text success:^(NSString *message) {
                
                [[QHDataManager manager] getMemberProfileWithUserId:nil username:self.usernameField.text success:^(QHMemberModel *member) {
                    ...
                    [QHDataManager manager].user = user;
